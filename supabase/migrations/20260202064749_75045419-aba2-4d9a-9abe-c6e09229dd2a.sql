-- Update the handle_new_user function to generate cleaner slugs
-- Priority: 1) Just name (e.g., "saira"), 2) Name + short suffix (e.g., "saira-a1")
...
BEGIN
  ...
  ELSE
    -- Name taken, add short suffix like "-a1", "-b2", etc.
    counter := 0;
    LOOP
      counter := counter + 1;
